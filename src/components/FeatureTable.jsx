            ...
            <table className="w-full text-left border-collapse">
                <thead>
                    <tr className="border-b border-white/10 bg-black/40">
                        <th className="p-6 font-sans text-sm font-semibold text-white/50 w-1/4">Features</th>
                        <th className="p-6 font-sans text-sm font-bold text-teal w-[18%] text-center">Starter</th>
                        <th className="p-6 font-sans text-sm font-bold text-white w-[18%] text-center">Growth Guard</th>
                        <th className="p-6 font-sans text-sm font-bold text-orange w-[21%] text-center">Institutional</th>
                        <th className="p-6 font-sans text-sm font-bold text-teal w-[18%] text-center">Launch Shield</th>
                    </tr>
                </thead>
                <tbody className="text-sm text-white/80 font-sans">
                    ...
                    <tr className="border-b border-white/5">
                        ...
                        <td className="p-5 text-center text-teal font-medium">War-room Prep</td>
                    </tr>
                    <tr className="border-b border-white/5">
                        ...
                        <td className="p-5 text-center text-teal font-medium">Bespoke TGE set</td>
                    </tr>
                    ...
                    <tr className="border-b border-white/5">
                        ...
                        <td className="p-5 text-center text-white/80">All platforms</td>
                    </tr>
                    <tr className="border-b border-white/5">
                        ...
                        <td className="p-5 text-center text-teal font-medium">Unlimited</td>
                        <td className="p-5 text-center text-teal font-medium">Unlimited (30d)</td>
                    </tr>
                    ...
                    <tr className="border-b border-white/5">
                        ...
                        <td className="p-5 text-center text-teal font-medium">Instant (Live)</td>
                    </tr>
                    <tr className="border-b border-white/5">
                    ...
                    <tr>
                        ...
                        <td className="p-5 text-center text-teal">✓</td>
                        <td className="p-5 text-center text-teal">✓</td>
                        <td className="p-5 text-center text-teal">✓ (Weekly)</td>
                    </tr>
                </tbody>
            </table>
        </div>
