        ...
        <div className="fixed top-6 left-0 right-0 z-50 flex justify-center px-4 mix-blend-normal">
            ...
            >
                <div className="flex items-center gap-3">
                    <img src="/KAI.png" alt="KAI Logo" className="h-[76px] w-auto object-contain" />
                ...
                <div className="hidden md:flex items-center gap-8 font-sans text-sm tracking-wide">
                    ...
                    <a href="https://dashboard.amazix.ai" target="_blank" rel="noopener noreferrer" className="hover:text-teal transition-colors">Dashboard</a>
                </div>
                <a
                    href="#scale"
